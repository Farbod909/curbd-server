...
urlpatterns = [
    ...
    path('fixedavailablities/', api_views.FixedAvailabilityList.as_view(), name='fixedavailability-list'),
    path('fixedavailablities/<int:pk>', api_views.FixedAvailabilityDetail.as_view(), name='fixedavailability-detail'),
