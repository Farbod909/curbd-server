    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('repeating_days', parking.fields.ChoiceArrayField(base_field=models.PositiveIntegerField(choices=[(1, 'Sunday'), (2, 'Monday'), (3, 'Tuesday'), (4, 'Wednesday'), (5, 'Thursday'), (6, 'Friday'), (7, 'Saturday')]), size=None)),
                ('pricing', models.PositiveIntegerField(default=15, help_text='The cost of parking at the space for 5 minutes')),
